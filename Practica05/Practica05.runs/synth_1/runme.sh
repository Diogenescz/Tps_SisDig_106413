...
HD_PWD='C:/Users/corne/Documents/sistemasDigitales/Practica/Practica05/Practica05.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ios.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ios.tcl
