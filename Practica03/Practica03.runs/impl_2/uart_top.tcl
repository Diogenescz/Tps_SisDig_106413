...
set rc [catch {
  ...
  add_files -quiet C:/Users/corne/Documents/sistemasDigitales/Practica/Practica03/Practica03.runs/synth_2/uart_top.dcp
  ...
  link_design -top uart_top -part xc7z010clg400-1
...
set rc [catch {
  ...
  create_report "impl_2_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file uart_top_bus_skew_routed.rpt -pb uart_top_bus_skew_routed.pb -rpx uart_top_bus_skew_routed.rpx"
